    ...
    >
      ...
      <div className={`flex h-full ${className}`}>
        ...
        <div className="flex-1 min-w-[300px] flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto bg-radial from-white to-[#F1F5F8]">
            {messages.length === 0 ? (
          ...
          <div className="p-6 bg-white border-t border-gray-200">
            ...
            <div className="flex items-center gap-2 p-2 bg-white border border-gray-200 rounded-xl shadow-sm">
              {/* <button
                ...
                className="p-2 bg-[#4596FF] rounded-lg transition-colors hover:bg-[#3B82F6]"
              >
                <AttachmentIcon />
              </button> */}
...
export default ChatInterfaceDraggable;
