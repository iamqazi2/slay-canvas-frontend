...
export default function Modal({
  ...
  const modalContent = (
    ...
    >
      ...
      {/* Modal */}
      <div
        className={`relative w-full ${sizeClasses[size]} bg-white rounded-lg shadow-xl transform transition-all duration-300 animate-in zoom-in-95 slide-in-from-bottom-4 ${className}`}
  ...
  // Render modal using portal to ensure it's rendered at the document body level
