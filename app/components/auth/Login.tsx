  ...
  return (
    <div className="flex m-auto items-center justify-center py-8 md:py-0 bg-white md:w-150 md:h-120  rounded-2xl">
      <div className="w-[400px] px-5 md:px-0">
        <FormHeading
          text="Welcome back👋"
          text2="Enter your credentials to access your account"
        />
        ...
        >
          ...
          <div className="flex justify-between items-center mt-2">
            <div className="flex gap-2 items-center">
              <div
                className={`w-4.5 h-4.5 border-1 border-gray-300 rounded-full cursor-pointer flex items-center justify-center ${
                  rememberMe ? "bg-gray-800" : ""
                }`}
