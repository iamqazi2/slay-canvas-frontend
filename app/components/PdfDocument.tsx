...
const PdfDocument: React.FC<PdfDocumentProps> = ({ className = "", id, initialData, onClose }) => {
  ...
  useEffect(() => {
    ...
    window.addEventListener("documentFilePasted", handleDocumentFilePasted as EventListener);
    return () => window.removeEventListener("documentFilePasted", handleDocumentFilePasted as EventListener);
  }, []);
  ...
  const handleDelete = (): void => {
    ...
    if (id === "sidebar-pdf-document" || onClose) {
      console.log("PdfDocument is sidebar component or has onClose prop, calling onClose");
      if (onClose) {
        onClose();
      }
      return;
    ...
    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <defs>
        ...
        >
          ...
          <feColorMatrix type="matrix" values="0 0 0 0 0.269231 0 0 0 0 0.586822 0 0 0 0 1 0 0 0 0.3 0" />
          <feBlend mode="normal" in2="BackgroundImageFix" result="effect1_dropShadow_62_3432" />
          <feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_62_3432" result="shape" />
        </filter>
      </defs>
    </svg>
  );
            ...
            <div className="space-y-2">
              ...
              <div className="overflow-hidden">
                <div className="text-xs truncate text-gray-600 overflow-hidden bg-gray-50 p-2 rounded">
                  {documentContent.length > 200 ? `${documentContent.substring(0, 200)}...` : documentContent}
                </div>
              </div>
            </div>
          ) : (
