...
export const testimonials = [
  {
    ...
    name: "Ava Thompson",
    img: "/client1.png",
    review: "This product has simplified my workflow. I finish tasks faster and finally have time to focus on more important things."
  },
  {
    id: 2,
    name: "Liam Patel",
    img: "/client2.png",
    review: "I didn’t expect it to be this good. The speed and accuracy really surprised me, and I use it every single day now."
  },
  {
    id: 3,
    name: "Emily Carter",
    img: "/client3.png",
    review: "The design is clean and easy to use. Even without much tech knowledge, I had no trouble getting started quickly."
  },
  {
    id: 4,
    name: "James Rodriguez",
    img: "/client4.jpg",
    review: "Running my business is easier with this tool. It saves time, reduces stress, and even my team enjoys working with it."
  },
  {
    id: 5,
    name: "Sophia Patel",
