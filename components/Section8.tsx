    ...
    return (
        <div className='w-full bg-gradient-to-r from-[#8e5eff] to-[#4596ff] relative overflow-hidden'>
            ...
            <div className='py-12 main-container'>
                ...
                <MainHeading text='Ready to Create Smarter?'
                ...
                <div className='mt-5'>
                    <Sec1Btn text='Start Free' text2='Watch Video' variant1="inverted" variant2="inverted" width='140px' icon1={assets.arrowRight} icon2={assets.play} />
                </div>
